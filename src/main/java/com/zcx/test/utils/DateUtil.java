...
import com.zcx.test.enums.DateStyle;
import com.zcx.test.enums.Week;
...
public class DateUtil {
	...
	/**
	 * 获取当前日期，默认YYYY_MM_DD_HH_MM_SS格式
	 * 
	 * @param format
	 * 
	 * @return 当前日期字符串
	...
	public static String getCurrentDate(String pattern) {
		if (pattern == null) {
			return DateToString(new Date(), DateStyle.YYYY_MM_DD_HH_MM_SS.getValue());
		} else {
	...
	public static void main(String[] args) {
		SimpleLunarCalendar test = new SimpleLunarCalendar(new Date());
		System.out.println(test.getDateString());
		System.out.println(DateToString(new Date(), DateStyle.YYYY_MM_DD_HH_MM_SS.getValue()));
	}
